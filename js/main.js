...
(function () {
  ...
  const STARTER_KIT = [
    { t: "A DeLonghi Dedica", d: "EC890 (Duo, has cold brew) or EC685. They're near-identical for espresso. ~₹13,999 new." },
  ...
  const GALLERY = [
    ...
    { src: "assets/img/puck.jpg", cap: "A knocked-out puck, post-shot." },
  ];
