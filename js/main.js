...
(function () {
  ...
  const SELLERS = [
    { name: "Latteholic", type: "Machines (new + open-box)", desc: "The trusted India distributor (also fulfils delonghi.co.in). EC890 ~₹20k new (Amazon), ~₹12k open-box (10k+ on a good day) — and open-box still carries the full 1-year warranty. The group's go-to. Just film your unboxing for open-box and you're set.",
